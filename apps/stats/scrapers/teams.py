...
class TeamsScraper(Scraper):
    ...
    def fetch_from_espn_data(cls):
        ...
        url = 'https://raw.githubusercontent.com/jokecamp/FootballData/master/epl-teams-2013-2014.json'
    ...
    def fetch_all_teams(cls):
        ...
        url ='https://raw.githubusercontent.com/jokecamp/FootballData/master/teams.json'
